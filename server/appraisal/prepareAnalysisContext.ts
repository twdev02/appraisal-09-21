  ...
  let researchGroups = effectiveGroups.map((g: any, gIdx: number) => {
    ...
    const groupDevices = (g.devices || g.deviceList || g.stents || []).map((d: any, dIdx: number) => {
      ...
      return {
        ...
        outcomeAttribution: d.outcomeAttribution,
